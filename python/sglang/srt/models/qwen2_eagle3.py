...
"""Inference-only Qwen2-EAGLE model compatible with HuggingFace weights."""
...
class Qwen2DecoderLayer(Qwen2DecoderLayer):
    def __init__(
        ...
        if config.model_type == "Qwen24_text":
...
class Qwen2Model(nn.Module):
    def __init__(
        ...
        self.midlayer = Qwen2DecoderLayer(config, 0, quant_config, prefix)
...
class Qwen2ForCausalLMEagle3(Qwen2ForCausalLM):
    def __init__(
        self,
        config: Qwen2Config,
        quant_config: Optional[QuantizationConfig] = None,
        ...
        # Qwen2 3.2 1B Instruct set tie_word_embeddings to True
        # Qwen2 3.1 8B Instruct set tie_word_embeddings to False
...
EntryClass = [Qwen2ForCausalLMEagle3]
